import { NavbarHome9, HeaderHome9, LatestReviewsHome9, StyleHome9, FooterHome9 } from '../../components';
  ...
  return (
    <>
      <div className="ps-page">
          ...
          <div className="ps-home ps-home--9">
              <div className="ps-home__content">

                  {/* HEADER SECTION */}
                  <HeaderHome9 />

                  <section className="ps-promo--mask">
                      <div className="ps-banner">
                          <div className="container">
                              <div className="ps-banner__block row-reverse">
                                  <div className="ps-banner__content">
                                      <h2 className="ps-banner__title">The best quality <br />masks at the best price</h2>
                                      <div className="ps-banner__btn-group">
                                          <div className="ps-banner__btn"><img src="img/bacteria.png" alt />Up to 5 users simultaneously</div>
                                          <div className="ps-banner__btn"><img src="img/certificate.png" alt />Has HEALTH certificate</div>
                                      </div><a className="ps-banner__shop bg-warning" href="#">Shop now</a>
                                  </div>
                                  <div className="ps-banner__thumnail"><img className="ps-banner__image" src="img/promotion/home9-mask.png" alt /></div>
                              </div>
                          </div>
                      </div>
                  </section>
                  <section className="ps-promo--mask">
                      <div className="ps-banner bg-white">
                          <div className="container">
                              <div className="ps-banner__block">
                                  <div className="ps-banner__content">
                                      <h2 className="ps-banner__title">Effective & reliable<br />protection for your family</h2>
                                      <div className="ps-banner__desc">Only this week 30% to 50% cheaper!<br />Choose a color that really matches your personality</div><a className="ps-banner__shop bg-warning" href="#">About</a>
                                  </div>
                                  <div className="ps-banner__thumnail"><img className="ps-banner__image" src="img/promotion/goby-unsplash.jpg" alt /></div>
                              </div>
                          </div>
                      </div>
                  </section>
                  ...
                  <section className="ps-section--newsletter ps-section--newsletter-full" style={{ backgroundImage: 'url("img/bg-newsletter.jpg")' }}>
                      <div className="container">
                          <div className="ps-section__content">
                              <h3 className="ps-section__title">Join our newsletter and get $20 discount for your first order</h3>
