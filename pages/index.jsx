  ...
  return (
    <>
      ...
      <div className="ps-page">
        ...
        {/* HEADER CAROUSEL */}
        <div className="ps-home ps-home--2">
            ...
            <div className="ps-search__item">
              <div className="ps-product ps-product--horizontal">
                ...
                <div className="ps-product__content">
                  <h5 className="ps-product__title">
                    <a>
                      Disposable Face <span className="hightlight">mask</span>{" "}
                      for Unisex
                    </a>
                  </h5>
                  <p className="ps-product__desc">
          ...
          <div className="modal-content">
            <div className="modal-body">
              <div className="wrap-modal-slider ps-compare__body">
                <button
                  className="close ps-compare__close"
                  type="button"
                  data-dismiss="modal"
                  aria-label="Close"
                >
                      ...
                      <table className="table ps-table">
                        <tbody>
                          <tr>
                            ...
                            <td>
                              ...
                              <div className="ps-product__thumbnail">
                                ...
                                >
                                  <figure>
                                    <img src="/img/products/034.jpg" alt />
                                  </figure>
                                </a>
                              </div>
                              <div className="ps-product__content">
                          ...
                          <tr>
                            <th>Availability</th>
                            <td>
                              <p className="ps-product__text ps-check-line">
                                in stock
                              </p>
                            </td>
                            <td>
                          ...
                          <tr>
                            ...
                            <td>
                              <span className="ps-product__del">$64.65</span>
                              <span className="ps-product__price sale">
                                $86.67
                              </span>
                            </td>
          ...
          <div className="modal-content">
            <div className="modal-body">
              <div className="wrap-modal-slider container-fluid">
                <button
                  className="close ps-popup__close"
                  type="button"
                  data-dismiss="modal"
                  aria-label="Close"
                >
          ...
          <div className="modal-content">
            <div className="modal-body">
              <div className="wrap-modal-slider container-fluid ps-addcart__body">
                <button
                  className="close ps-addcart__close"
                  type="button"
                  data-dismiss="modal"
                  aria-label="Close"
                >
                ...
                <p className="ps-addcart__noti">
                  {" "}
                  <i className="fa fa-check"> </i>Added to cart succesfully
                </p>
                <div className="row">
                  ...
                  <div className="col-12 col-md-6">
                    <div className="ps-addcart__content">
                      ...
                      <p className="ps-addcart__total">
                        Total: <span className="ps-price">$44.00</span>
                      </p>
                      <a
                        className="ps-btn ps-btn--border"
                        href="#"
                        data-dismiss="modal"
                        aria-label="Close"
                      >
          ...
          <div className="modal-content">
            <div className="modal-body">
              <div className="wrap-modal-slider container-fluid ps-addcart__body">
                    ...
                    <div className="ps-product__thumbnail">
                      <a className="ps-product__image" href="#">
                        <figure>
                          ...
                          <img src="/img/products/040.jpg" alt />
                        </figure>
                      </a>
                    </div>
                    <div className="ps-product__content">
                      ...
                      <div className="ps-product__meta">
                        <span className="ps-product__price">$89.65</span>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  >
                    ...
                    <div className="ps-product ps-product--standard">
                      <div className="ps-product__thumbnail">
                        <a className="ps-product__image" href="product1.html">
                          <figure>
                            <img src="/img/products/020.jpg" alt="alt" />
                            <img src="/img/products/008.jpg" alt="alt" />
                          </figure>
                        </a>
                        <div className="ps-product__actions">
                ...
                <div className="ps-addcart__footer">
                  <a
                    className="ps-btn ps-btn--border"
                    href="#"
                    data-dismiss="modal"
