import { NavbarHome10, HeaderHome10, LatestReviewsHome10, StyleHome10, FooterHome10 } from '../../components';
...
const Home10 = () => {
  return (
    ...
    <div className="ps-page">
        ...
        <div className="ps-home ps-home--10">
                            ...
                            <div className="ps-banner__block">
                                <div className="ps-banner__content">
                                    ...
                                    <div className="ps-banner__btn-group">
                                        <div className="ps-banner__btn"><img src="img/icon4.png" alt />Up to 5 users simultaneously</div>
                                        <div className="ps-banner__btn"><img src="img/ul-icon3.png" alt />Has HEALTH certificate</div>
                                    </div><a className="ps-banner__shop bg-warning" href="#">Shop now</a>
                                </div>
                                <div className="ps-banner__thumnail"><img className="ps-banner__image" src="img/promotion/face-masks.jpg" alt />
                    ...
                    <div className="ps-banner bg-white">
                        <div className="container">
                            <div className="ps-banner__block">
                                ...
                                <div className="ps-banner__thumnail"><img className="ps-banner__image" src="img/promotion/goby-unsplash-1.jpg" alt /></div>
                            </div>
                        </div>
                    </div>
                </section>
