import { NavbarHome7, HeaderHome7, LatestReviewsHome7, StyleHome7, FooterHome7 } from '../../components';
...
const Home7 = () => {
  return (
    ...
    <div className="ps-page">
        ...
        <div className="ps-home ps-home--7">
            ...
            <div className="ps-home__content">
                <div className="container">
                    ...
                    <section className="ps-about--info">
                        <h2 className="ps-about__title">Effective and reliable <br />protection for your teeth</h2>
                        <p className="ps-about__subtitle">The brush handle fits perfectly in the hand, is slim and beautifully made.</p>
                        <div className="ps-about__extent">
                            <div className="row m-0">
                                <div className="col-12 col-md-4 p-0">
                                    <div className="ps-block--about">
                                        <div className="ps-block__icon"><img src="img/certificate-navy.png" alt="" /></div>
                                        <h4 className="ps-block__title">Health Certificate 2000 - <br/>professional care</h4>
                                        <div className="ps-block__subtitle">The highest quality and protection for your teeth</div>
                                    </div>
                                </div>
                                <div className="col-12 col-md-4 p-0">
                                    <div className="ps-block--about">
                                        <div className="ps-block__icon"><img src="img/dentistry-icon.png" alt="" /></div>
                                        <h4 className="ps-block__title">Sonic cleaning <br/>and whitening power</h4>
                                        <div className="ps-block__subtitle">At the same time, it protects and whitens</div>
                                    </div>
                                </div>
                                <div className="col-12 col-md-4 p-0">
                                    <div className="ps-block--about">
                                        <div className="ps-block__icon"><img src="img/toothbrush-icon.png" alt="" /></div>
                                        <h4 className="ps-block__title">3 types <br/>of cleaning tips</h4>
                                        <div className="ps-block__subtitle">Round, rectangular and super-wide</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="container">
                            <div className="ps-banner__block">
                                <div className="ps-banner__content">
                                    ...
                                    <div className="ps-banner__desc">Only this week 30% to 50% cheaper!</div>
                                ...
                                <div className="ps-banner__thumnail">
                                    ...
                                    </div><img className="ps-banner__image" src="img/about/goby-tD3GaS9ysF4-unsplash-1.jpg" alt />
                                    <div id="ps-video-gallery">
                                        <div className="video" data-html="#video1" data-poster="img/about/goby-tD3GaS9ysF4-unsplash-1.jpg"><a href="">
                                                <div className="ps-banner__video"><i className="fa fa-play"></i></div>
                                            </a></div>
                                    </div>
                                </div>
                            </div>
                ...
                <section className="ps-section--choose-style" data-background="img/related-bg.jpg">

                    {/* STYLE SECTION */}
                    <StyleHome7 />

                </section>
                <div className="ps-home__block">
                    <div className="container">
                        <div className="ps-home__row">
                            ...
                            <div className="ps-home__newsletter">
                                <section className="ps-section--newsletter" data-background="img/newsletter-bg.jpg">
                                    <h3 className="ps-section__title">Join our newsletter and get $20 discount!</h3>
                                    <p className="ps-section__text">*Only for the first order.</p>
