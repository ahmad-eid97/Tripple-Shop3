...
const NavbarHome8 = () => {
  return (
    <>
                  ...
                  <div className="ps-navigation__left">
                      <nav className="ps-main-menu">
                          <ul className="menu">
                              ...
                              <li className="has-mega-menu"><a href="#">Sale</a></li>
                              <li className="has-mega-menu"><a href="#">Best Deals</a></li>
                              <li className="has-mega-menu"><a href="#">Detal tools</a></li>
                              <li className="has-mega-menu"><a href="#">Dental</a></li>
                          </ul>
                      </nav>
                  </div>
      ...
      <header className="ps-header ps-header--8 ps-header--mobile">
          <div className="ps-noti">
              <div className="container">
                  <p className="m-0">Due to the <strong>COVID 19 </strong>epidemic, orders may be processed with a slight delay</p>
              </div><a className="ps-noti__close"><i className="icon-cross"></i></a>
