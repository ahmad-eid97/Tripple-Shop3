...
const NavbarHome10 = () => {
  return (
    <>
      <header className="ps-header ps-header--2 ps-header--10">
          ...
          <div className="ps-header__middle">
              <div className="container">
                  <div className="ps-logo"><a href="index.html"> <img src="img/logo.png" alt /><img className="sticky-logo" src="img/sticky-logo.png" alt /><img className="logo-white" src="img/logo-white.png" alt /></a></div>
      ...
      <header className="ps-header ps-header--10 ps-header--mobile">
          <div className="ps-noti">
              <div className="container">
                  <p className="m-0">Due to the <strong>COVID 19 </strong>epidemic, orders may be processed with a slight delay</p>
              </div><a className="ps-noti__close"><i className="icon-cross"></i></a>
