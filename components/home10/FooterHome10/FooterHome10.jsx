const FooterHome10 = () => {
  return (
    ...
    <footer className="ps-footer ps-footer--8">
                    ...
                    <div className="row">
                        ...
                        <div className="col-12 col-md-8">
                            <div className="ps-footer--contact">
                                ...
                                <div className="ps-footer__fax"><i className="fa-regular fa-phone"></i>0020 500 – MYMEDI – 000</div>
                                <p className="ps-footer__work">Monday – Friday: 9:00-20:00<br />Saturday: 11:00 – 15:00</p>
                                <hr />
                                <p><a className="ps-footer__email" href="mailto:contact@example.com"> <i className="fa-regular fa-envelope"></i>contact@example.com </a></p>
                            </div>
                        </div>
                    </div>
                </div>
