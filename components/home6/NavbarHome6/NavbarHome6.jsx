...
const NavbarHome6 = () => {
  return (
    ...
    <header className="ps-header ps-header--3 ps-header--6">
            ...
            <div className="ps-header__middle">
                <div className="container">
                    <div className="ps-header__left">
                        <ul className="ps-header__icons">
                            <li><a className="ps-header__item menu-slide" href="#"><i className="fa fa-bars"></i></a></li>
                        </ul>
                    </div>
