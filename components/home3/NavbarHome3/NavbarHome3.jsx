...
const NavbarHome3 = () => {
  return (
    <>
      <header className="ps-header ps-header--3">
        ...
        <div className="ps-header__middle">
            <div className="container">
                ...
                <div className="ps-header__right">
                    ...
                    <div className="ps-middle__social">
                        <ul className="ps-social">
                            <li><a className="ps-social__link facebook" href="#"><i className="fa-brands fa-facebook-f"> </i><span className="ps-tooltip">Facebook</span></a></li>
                            <li><a className="ps-social__link instagram" href="#"><i className="fa-brands fa-instagram"></i><span className="ps-tooltip">Instagram</span></a></li>
                            <li><a className="ps-social__link youtube" href="#"><i className="fa fa-youtube-play"></i><span className="ps-tooltip">Youtube</span></a></li>
            ...
            <div className="ps-header3-search-mobile">
                <div className="container">
                    <div className="ps-search__content">
                        <div className="ps-menu__sticky"><a className="menu-slide" href="#"><i className="fa fa-bars"></i>Products</a></div>
                        <div className="ps-header__menu">
                            <ul className="menu">
                                <li className="fa fa-bars has-mega-menu"><a href="#">Products<span className="sub-toggle"><i className="fa fa-chevron-down"></i></span></a>
                                    <div className="mega-menu">
      ...
      <header className="ps-header ps-header--3 ps-header--mobile">
          <div className="ps-noti">
              <div className="container">
                  <p className="m-0">Due to the <strong>COVID 19 </strong>epidemic, orders may be processed with a slight delay</p>
              </div><a className="ps-noti__close"><i className="icon-cross"></i></a>
