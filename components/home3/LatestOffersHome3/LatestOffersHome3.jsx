  ...
  return (
    <div className="ps-promo">
        ...
        <div className="row">
            ...
            <div className="col-12 col-md-4">
                <div className="ps-promo__item"><img className="ps-promo__banner" src="img/promotion/bg-banner3.jpg" alt="alt" />
                    <div className="ps-promo__content">
...
export default LatestOffersHome3