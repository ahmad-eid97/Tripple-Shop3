    ...
    <>
      <header className="ps-header ps-header--5">
          ...
          <div className="ps-header__middle">
              <div className="container">
                  <div className="ps-logo"><a href="index.html"> <img src="img/logo-white.png" alt /><img className="sticky-logo" src="img/logo-white.png" alt /></a></div><a className="ps-menu--sticky" href="#"><i className="fa fa-bars"></i></a>
                  <div className="ps-header__block">
                      <div className="ps-middle__text">Need help? <strong>0020 500 - MYMEDI - 000</strong></div>
                  ...
                  <div className="ps-navigation__left">
                      <nav className="ps-main-menu">
                          <ul className="menu">
                                      ...
                                      <div className="container">
                                          ...
                                          <div className="ps-branch">
                                              ...
                                              <div className="ps-branch__box">
                                                  <div className="ps-branch__item"><a href="#"><img src="img/branch/brand-1.jpg" alt="alt" /></a></div>
                                                  <div className="ps-branch__item"><a href="#"><img src="img/branch/brand-2.jpg" alt="alt" /></a></div>
                                                  <div className="ps-branch__item"><a href="#"><img src="img/branch/brand-3.jpg" alt="alt" /></a></div>
                                                  <div className="ps-branch__item"><a href="#"><img src="img/branch/brand-4.jpg" alt="alt" /></a></div>
                                                  <div className="ps-branch__item"><a href="#"><img src="img/branch/brand-5.jpg" alt="alt" /></a></div>
                                                  <div className="ps-branch__item"><a href="#"><img src="img/branch/brand-6.jpg" alt="alt" /></a></div>
                                                  <div className="ps-branch__item"><a href="#"><img src="img/branch/brand-7.jpg" alt="alt" /></a></div>
                                                  <div className="ps-branch__item"><a href="#"><img src="img/branch/brand-8.jpg" alt="alt" /></a></div>
                                                  <div className="ps-branch__item"><a href="#"><img src="img/branch/brand-9.jpg" alt="alt" /></a></div>
                                                  <div className="ps-branch__item"><a href="#"><img src="img/branch/brand-10.jpg" alt="alt" /></a></div>
                                              </div>
                                          </div>
                                      </div>
                                  </div>
                              </li>
                              <li className="has-mega-menu"><a href="#">Home Medical Supplies<span className="sub-toggle"><i className="fa fa-chevron-down"></i></span></a>
                                  <div className="mega-menu">
                                      <div className="container">
                                          <div className="mega-menu__row">
                                              ...
                                              <div className="mega-menu__column col-12 col-sm-4 col-md-3">
                                                  <div className="mega-menu__product">
                                                      ...
                                                      <div className="ps-product ps-product--standard">
                                                          ...
                                                          <div className="ps-product__content">
                                                              <h5 className="ps-product__title"><a href="product1.html">Generic Stethoscope Hearing Heartbeat Tool</a></h5>
                              ...
                              <li className="has-mega-menu"><a href="#">Homepages<span className="sub-toggle"><i className="fa fa-chevron-down"></i></span></a>
                                  <div className="mega-menu">
                                      <div className="container">
                              ...
                              <li className="has-mega-menu"><a href="#">Pages<span className="sub-toggle"><i className="fa fa-chevron-down"></i></span></a>
                                  <div className="mega-menu">
                                      <div className="container">
                                          <div className="mega-menu__row">
                                              <div className="mega-menu__column">
                              ...
                              <li className="has-mega-menu"><a href="#">Collection<span className="sub-toggle"><i className="fa fa-chevron-down"></i></span></a>
                                  <div className="mega-menu">
                                      <div className="container">
                                          <div className="mega-menu__row">
      ...
      <header className="ps-header ps-header--5 ps-header--mobile">
          <div className="ps-noti">
              <div className="container">
                  <p className="m-0">Due to the <strong>COVID 19 </strong>epidemic, orders may be processed with a slight delay</p>
              </div><a className="ps-noti__close"><i className="icon-cross"></i></a>
          ...
          <div className="ps-header__top">
              <ul className="ps-header__icons">
                  <li><a className="ps-header__item" href="javascript: void(0)" id="open-menu-top"><i className="fa fa-bars"></i></a><a className="ps-header__item" href="#" id="close-menu-top"><i className="icon-cross"></i></a></li>
                  <li><a className="ps-header__item open-search" href="javascript: void(0)"><i className="fa fa-search"></i></a></li>
                  <li><a className="ps-header__item" href="#"><i className="fa-regular fa-user"></i></a></li>
                  <li><a className="ps-header__item" href="#"><i className="fa-regular fa-heart"></i><span className="badge">3</span></a></li>
                  <li><a className="ps-header__item" href="shopping-cart.html"><i className="fa-regular fa-cart-shopping"></i><span className="badge">2</span></a></li>
              </ul>
          </div>
          <div className="ps-header__middle">
              <div className="container">
                  <div className="ps-logo"><a href="index.html"> <img src="img/logo-white.png" alt /></a></div>
                  <div className="ps-header__right">
                      <div className="ps-language-currency"><a className="ps-dropdown-value" href="javascript:void(0);" data-toggle="modal" data-target="#popupLanguage">English</a><a className="ps-dropdown-value" href="javascript:void(0);" data-toggle="modal" data-target="#popupCurrency">USD</a></div>
                  </div>
              </div>
          </div>
      </header>
