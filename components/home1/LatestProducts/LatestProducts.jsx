                ...
                <div className="ps-product__thumbnail">
                  <a className="ps-product__image" href="product1.html">
                    <figure>
                      ...
                      <img src="/img/product6.jpg" alt="alt" />
                    </figure>
                  </a>
                  <div className="ps-product__actions">
                    <div
            ...
            <div className="ps-section__product">
              <div className="ps-product ps-product--standard">
                <div className="ps-product__thumbnail">
                  <a className="ps-product__image" href="product1.html">
                    <figure>
                      <img src="/img/product7.jpg" alt="alt" />
                      <img src="/img/product8.jpg" alt="alt" />
                    </figure>
                  </a>
                  <div className="ps-product__actions">
                    <div
            ...
            <div className="ps-section__product">
              <div className="ps-product ps-product--standard">
                <div className="ps-product__thumbnail">
                  <a className="ps-product__image" href="product1.html">
                    <figure>
                      <img src="/img/product11.jpg" alt="alt" />
                      <img src="/img/product12.jpg" alt="alt" />
                    </figure>
                  </a>
                  <div className="ps-product__actions">
                    <div
