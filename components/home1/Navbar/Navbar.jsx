...
const Navbar = () => {
  return (
    <>
      <header className="ps-header ps-header--2">
          ...
          <div className="container">
            <div className="ps-navigation__left">
              <nav className="ps-main-menu">
                <ul className="menu">
                  <li className="fa fa-bars has-mega-menu">
                    <a href="#">
                      Products
                        ...
                        <div className="mega-menu__row">
                          <div className="mega-menu__column">
                            ...
                            <ul className="sub-menu--mega">
                              <li>
                                <a href="blog-post1.html">Bandages</a>
                              </li>
                              <li>
                                <a href="blog-post1.html">Gypsum foundations</a>
                              </li>
                              <li>
                                <a href="blog-post1.html">Patches and tapes</a>
                              </li>
                              <li>
                                <a href="blog-post1.html">Stomatology</a>
                              </li>
                              <li>
                                <a href="blog-post1.html">Surgical sutures</a>
                              </li>
                              <li>
                                <a href="blog-post1.html">Uniforms</a>
                              </li>
                              <li>
                                <a href="blog-post1.html">Wound healing</a>
                              </li>
                            </ul>
                          </div>
                          <div className="mega-menu__column">
                            ...
                            <ul className="sub-menu--mega">
                              ...
                              <li>
                                <a href="blog-post1.html">Face masks</a>
                              </li>
                              <li>
                                <a href="blog-post1.html">Gloves</a>
                              </li>
                              <li>
                                <a href="blog-post1.html">Protective covers</a>
                              </li>
                              <li>
                                <a href="blog-post1.html">Sterilization</a>
                              </li>
                              <li>
                                <a href="blog-post1.html">Surgical foils</a>
                              </li>
                              <li>
                                <a href="blog-post1.html">Uniforms</a>
                              </li>
                          ...
                          <div className="mega-menu__column">
                            ...
                            <ul className="sub-menu--mega">
                              <li>
                                <a href="blog-post1.html">Devices</a>
                              </li>
                              <li>
                                <a href="blog-post1.html">Diagnostic tests</a>
                              </li>
                              <li>
                                <a href="blog-post1.html">Disinfectants</a>
                              </li>
                              <li>
                                <a href="blog-post1.html">Dyes</a>
                              </li>
                              <li>
                                <a href="blog-post1.html">Pipettes</a>
                              </li>
                              <li>
                                <a href="blog-post1.html">Test-tubes</a>
                              </li>
                              <li>
                                <a href="blog-post1.html">Tubes</a>
                              </li>
                            </ul>
                          </div>
                          <div className="mega-menu__column">
                            ...
                            <ul className="sub-menu--mega">
                              <li>
                                <a href="blog-post1.html">Accessories Tools</a>
                              </li>
                              <li>
                                <a href="blog-post1.html">Blood pressure</a>
                              </li>
                              <li>
                                <a href="blog-post1.html">Capsules</a>
                              </li>
                              <li>
                                <a href="blog-post1.html">Dental</a>
                              </li>
                              <li>
                                <a href="blog-post1.html">Micrscope</a>
                              </li>
                              <li>
                                <a href="blog-post1.html">Pressure</a>
                              </li>
                              <li>
                                <a href="blog-post1.html">Sugar level</a>
                              </li>
                            </ul>
                          </div>
                          <div className="mega-menu__column">
                            ...
                            <ul className="sub-menu--mega">
                              <li>
                                <a href="blog-post1.html">Biopsy tools</a>
                              </li>
                              <li>
                                <a href="blog-post1.html">Endoscopes</a>
                              </li>
                              <li>
                                <a href="blog-post1.html">Monitoring</a>
                              </li>
                              <li>
                                <a href="blog-post1.html">Otoscopes</a>
                              </li>
                              <li>
                                <a href="blog-post1.html">
                              ...
                              <li>
                                <a href="blog-post1.html">Thermometer</a>
                              </li>
                            </ul>
                          </div>
                          <div className="mega-menu__column">
                            ...
                            <ul className="sub-menu--mega">
                              <li>
                                <a href="blog-post1.html">Blades</a>
                              </li>
                              <li>
                                <a href="blog-post1.html">Education</a>
                              </li>
                              <li>
                                <a href="blog-post1.html">Germicidal lamps</a>
                              </li>
                              <li>
                                <a href="blog-post1.html">Heart Health</a>
                              </li>
                              <li>
                                <a href="blog-post1.html">Infusion stands</a>
                              </li>
                              <li>
                                <a href="blog-post1.html">Lighting</a>
                              </li>
                              <li>
                                <a href="blog-post1.html">Machines</a>
                              </li>
                            </ul>
                          </div>
                        </div>
                        ...
                        <div className="mega-menu__row">
                          <div className="mega-menu__column col-12 col-sm-3">
                            <ul className="sub-menu--mega sub-menu--bold">
                              <li>
                                <a href="blog-post1.html">Diagnosis</a>
                              </li>
                              <li>
                                <a href="blog-post1.html">Accessories Tools</a>
                              </li>
                              ...
                              <li>
                                <a href="blog-post1.html">Equipment</a>
                              </li>
                              <li>
                                <a href="blog-post1.html">Show all</a>
                              </li>
                            </ul>
                          </div>
      ...
      <header className="ps-header ps-header--2 ps-header--mobile">
        <div className="ps-noti">
          <div className="container">
            <p className="m-0">
              Due to the <strong>COVID 19 </strong>epidemic, orders may be
