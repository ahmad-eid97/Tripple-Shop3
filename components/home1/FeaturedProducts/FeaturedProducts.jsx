              ...
              <div className="ps-product ps-product--standard">
                <div className="ps-product__thumbnail">
                  <a className="ps-product__image" href="product1.html">
                    <figure>
                      <img src="/img/product25.jpg" alt="alt" />
                      <img src="/img/product26.jpg" alt="alt" />
                    </figure>
                  </a>
            ...
            <div className="ps-section__product">
              <div className="ps-product ps-product--standard">
                <div className="ps-product__thumbnail">
                  <a className="ps-product__image" href="product1.html">
                    <figure>
                      <img src="/img/product27.jpg" alt="alt" />
                      <img src="/img/product28.jpg" alt="alt" />
                    </figure>
                  </a>
                  <div className="ps-product__actions">
                    <div
            ...
            <div className="ps-section__product">
              <div className="ps-product ps-product--standard">
                <div className="ps-product__thumbnail">
                  <a className="ps-product__image" href="product1.html">
                    <figure>
                      <img src="/img/product29.jpg" alt="alt" />
                      <img src="/img/product30.jpg" alt="alt" />
                    </figure>
                  </a>
                  <div className="ps-product__actions">
                    <div
            ...
            <div className="ps-section__product">
              <div className="ps-product ps-product--standard">
                <div className="ps-product__thumbnail">
                  <a className="ps-product__image" href="product1.html">
                    <figure>
                      <img src="/img/product31.jpg" alt="alt" />
                      <img src="/img/product32.jpg" alt="alt" />
                    </figure>
                  </a>
                  <div className="ps-product__actions">
                    <div
            ...
            <div className="ps-section__product">
              <div className="ps-product ps-product--standard">
                <div className="ps-product__thumbnail">
                  <a className="ps-product__image" href="product1.html">
                    <figure>
                      <img src="/img/product33.jpg" alt="alt" />
                      <img src="/img/product34.jpg" alt="alt" />
                    </figure>
                  </a>
                  <div className="ps-product__actions">
                    <div
            ...
            <div className="ps-section__product">
              <div className="ps-product ps-product--standard">
                <div className="ps-product__thumbnail">
                  <a className="ps-product__image" href="product1.html">
                    <figure>
                      <img src="/img/product35.jpg" alt="alt" />
                      <img src="/img/product36.jpg" alt="alt" />
                    </figure>
                  </a>
                  <div className="ps-product__actions">
                    <div
            ...
            <div className="ps-section__product">
              <div className="ps-product ps-product--standard">
                <div className="ps-product__thumbnail">
                  <a className="ps-product__image" href="product1.html">
                    <figure>
                      <img src="/img/product38.jpg" alt="alt" />
                      <img src="/img/product37.jpg" alt="alt" />
                    </figure>
                  </a>
                  <div className="ps-product__actions">
                    <div
            ...
            <div className="ps-section__product">
              <div className="ps-product ps-product--standard">
                <div className="ps-product__thumbnail">
                  <a className="ps-product__image" href="product1.html">
                    <figure>
                      <img src="/img/product39.jpg" alt="alt" />
                      <img src="/img/product40.jpg" alt="alt" />
                    </figure>
                  </a>
                  <div className="ps-product__actions">
                    <div
            ...
            <div className="ps-section__product">
              <div className="ps-product ps-product--standard">
                <div className="ps-product__thumbnail">
                  <a className="ps-product__image" href="product1.html">
                    <figure>
                      <img src="/img/product41.jpg" alt="alt" />
                      <img src="/img/product42.jpg" alt="alt" />
                    </figure>
                  </a>
                  <div className="ps-product__actions">
                    <div
            ...
            <div className="ps-section__product">
              <div className="ps-product ps-product--standard">
                <div className="ps-product__thumbnail">
                  <a className="ps-product__image" href="product1.html">
                    <figure>
                      <img src="/img/product43.jpg" alt="alt" />
                      <img src="/img/product44.jpg" alt="alt" />
                    </figure>
                  </a>
                  <div className="ps-product__actions">
                    <div
