            ...
            <div className="col-12 col-md-4">
                <div className="ps-block__image">
                    <section className="ps-home__banner">
                        <div className="ps-banner" style={{ background:'#FFCC00' }}><img className="ps-banner__overlay" src="img/promotion/bg-banner15.jpg" alt="alt" />
                            <div className="ps-banner__block">
                                <div className="ps-banner__content">
                                    <h2 className="ps-banner__title">Take care of <br/>yourself and <br/>your loved ones</h2>
                                    ...
                                    </div><a className="bg-yellow ps-banner__shop" href="#">Face mask</a>
                                </div>
                            </div>
                        </div>
                    </section>
                    ...
                    <div className="row m-0">
                        <div className="col-6 col-lg-4 p-0">
                            <div className="ps-product ps-product--standard">
                                ...
                                <div className="ps-product__content">
                                    <h5 className="ps-product__title"><a href="product1.html">Protectiva Soft absorbent pads, 30 pcs.</a></h5>
                                    <div className="ps-product__meta"><span className="ps-product__price sale">$38.39</span><span className="ps-product__del">$35.99</span>
                                    </div>
                        ...
                        <div className="col-6 col-lg-4 p-0">
                            <div className="ps-product ps-product--standard">
                                ...
                                <div className="ps-product__content">
                                    <h5 className="ps-product__title"><a href="product1.html">3-Ply Ear-Loop Disposable Blue Face Mask</a></h5>
                                    <div className="ps-product__meta"><span className="ps-product__price sale">$32.39</span><span className="ps-product__del">$14.99</span>
                                    </div>
                                    <div className="ps-product__rating">
                                        <select className="ps-rating" data-read-only="true">
                                            <option value="1">1</option>
                        ...
                        <div className="col-6 col-lg-4 p-0">
                            <div className="ps-product ps-product--standard">
                                ...
                                <div className="ps-product__content">
                                    <h5 className="ps-product__title"><a href="product1.html">Disposable Face Mask for Unisex</a></h5>
                                    <div className="ps-product__meta"><span className="ps-product__price sale">$20.39</span><span className="ps-product__del">$8.15</span>
                                    </div>
                                    <div className="ps-product__rating">
                                        <select className="ps-rating" data-read-only="true">
                                            <option value="1">1</option>
                        ...
                        <div className="col-6 col-lg-4 p-0">
                            <div className="ps-product ps-product--standard">
                                ...
                                <div className="ps-product__content">
                                    <h5 className="ps-product__title"><a href="product1.html">3 Layer Disposable Protective Face Masks</a></h5>
                                    <div className="ps-product__meta"><span className="ps-product__price sale">$15.52</span><span className="ps-product__del">$14.52</span>
                                    </div>
                                    <div className="ps-product__rating">
                                        <select className="ps-rating" data-read-only="true">
                                            <option value="1">1</option>
                        ...
                        <div className="col-6 col-lg-4 p-0">
                            <div className="ps-product ps-product--standard">
                                ...
                                <div className="ps-product__content">
                                    <h5 className="ps-product__title"><a href="product1.html">3-layer mask with an elastic band (1 piece)</a></h5>
                        ...
                        <div className="col-6 col-lg-4 p-0">
                            <div className="ps-product ps-product--standard">
                                ...
                                <div className="ps-product__content">
                                    <h5 className="ps-product__title"><a href="product1.html">3-Ply Ear-Loop Disposable Blue Face Mask</a></h5>
                                    <div className="ps-product__meta"><span className="ps-product__price sale">$32.84</span><span className="ps-product__del">$14.99</span>
                                    </div>
                                    <div className="ps-product__rating">
                                        <select className="ps-rating" data-read-only="true">
                                            <option value="1">1</option>
...
export default TakeCareProductsHome2;